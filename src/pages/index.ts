...
import ConsumindoApis from "./consume-apis/consumindo-apis";
import SobrePaipers from "./about-paipers/sobre-paipers";

export {FormBasico, FormCompleto, Callback, Promise, AsyncAwait, Home, ConsumindoApis, SobrePaipers};